...
public final class CodeScannerView extends ViewGroup {
    ...
    private void initialize(@NonNull final Context context, @Nullable final AttributeSet attrs,
        ...
        mAutoFocusButton.setImageResource(R.drawable.circle_white);
        ...
        mFlashButton.setImageResource(R.drawable.circle_white);
    ...
    void setAutoFocusEnabled(final boolean enabled) {
        mAutoFocusButton.setImageResource(enabled ? R.drawable.circle_white :
                R.drawable.circle_white);
    }

    void setFlashEnabled(final boolean enabled) {
        mFlashButton.setImageResource(enabled ? R.drawable.circle_white :
                R.drawable.circle_white);
    }
