package com.madison.gamuda.supervisor.extention.customview.scancode;
...
import com.madison.gamuda.supervisor.extention.helper.utils.DisplayUtils;
...
final class ViewFinderView extends View {
    ...
    protected void onDraw(@NonNull final Canvas canvas) {
        ...
        mTextPaint.setTextSize(DisplayUtils.Companion.convertDpToPx(getContext(), 16));
        Typeface typeface = ResourcesCompat.getFont(getContext(), R.font.helvetica_neue_regular);

        mTextPaint.setTypeface(typeface);
        drawCenter(canvas, mTextPaint, getResources().getString(R.string.align_qr_code));
    }
    ...
    private void drawCenter(Canvas canvas, Paint paint, String text) {
        ...
        canvas.drawText(text, x, mFrameRect.getBottom() + DisplayUtils.Companion.convertDpToPx(getContext(), 30), paint);
    }
    ...
    private void invalidateFrameRect(final int width, final int height) {
        if (width > 0 && height > 0) {
            ...
            r = new android.graphics.Rect(frameLeft, mFrameRect.getBottom() - 50, frameLeft + frameWidth, mFrameRect.getBottom() + 100);
        }
    }
}
